  ...
  [11],
  {
    '4WSj': function (e, t, n) {
      ...
      var f = function (e) {
        ...
        v = function (e, t) {
          switch (t.type) {
            ...
            case 'ADD_ITEM':
              return c(c({}, e), {}, { items: s(e, t) });
            case 'REMOVE_ITEM':
              return c(c({}, e), {}, { items: l(e, t) });
            case 'CLEAR_ITEM_FROM_CART':
              return c(c({}, e), {}, { items: d(e, t) });
            case 'CLEAR_CART':
              return c(c({}, e), {}, { items: [] });
            case 'APPLY_COUPON':
      ...
      var _ = function (e, t) {
        ...
        I = function (e, t) {
          return new Promise(function (n, r) {
            ...
            m.a.getItem(o, function (i, a) {
              a !== e.version
                ? ((t = e.migrate(t)),
                  m.a.setItem(e.key, _(t), function (i) {
                    if (i) return r(i);
                    m.a.setItem(o, e.version, function (e) {
                      return e ? r(e) : n(t);
                    });
                  }))
                : n(t);
                      ...
                      for (;;)
                        switch ((e.prev = e.next)) {
                          case 0:
                            return (
                              (e.next = 2),
                              m.a.getItem(w.key, function (e, n) {
                                if (e) return i(!0), c(e);
                                var r = _(n);
                                'function' === typeof w.migrate
                                  ? I(w, r)
                                      .then(function (e) {
                                        return t(e);
                                      })
      ...
      var R = Object(o.createContext)({}),
        N = { isOpen: !1, items: [], isRestaurant: !1, coupon: null },
        C = function (e) {
          var t,
            n = e.children,
            r = (function () {
              var e,
                ...
                g = function () {
                  return f(r.items).toFixed(2);
                },
                _ = function () {
                  return f(r.items, r.coupon).toFixed(2);
                },
                I = function () {
                  var e,
                    t = f(r.items);
            ...
            I = r.getDiscount,
            w = r.toggleRestaurant,
            S = O(i, a);
          S.rehydrated, S.error;
          return E(
            R.Provider,
            {
              value: {
        ...
        })(
          {
            ...
            4: [
              function (e, t, n) {
                ...
                function D(e) {
                  return c([_(atob(e.data))], { type: e.type });
                }
                function P(e) {
                ...
                function k(e) {
                  O(e);
                  for (
                    var t = y[e.name], n = t.forages, r = 0;
                    r < n.length;
                    r++
                  ) {
                    var o = n[r];
                ...
                function L(e) {
                  ...
                  return f
                    .all(i)
                    .then(function () {
                      return (n.db = o.db), R(n);
                    })
                    .then(function (e) {
                      return (
                        (n.db = e), C(n, t._defaultConfig.version) ? N(n) : e
                      );
                    })
                    .then(function (e) {
                  ...
                  var o = new f(function (n, o) {
                    ...
                    r.ready()
                      .then(function () {
                        return (
                          (i = r._dbInfo),
                          '[object Blob]' === b.call(t)
                            ? w(i.db).then(function (e) {
                                return e ? t : A(t);
                              })
                            : t
                        );
                ...
                function J(e, t) {
                  ...
                  if (e.name) {
                    var i =
                      e.name === n.name && o._dbInfo.db
                        ? f.resolve(o._dbInfo.db)
                        : R(e).then(function (t) {
                            var n = y[e.name],
                              r = n.forages;
                            n.db = t;
                    ...
                    r = e.storeName
                      ...
                      : i.then(function (t) {
                          ...
                          return new f(function (t, n) {
                            ...
                            .catch(function (t) {
                              throw (
                                ((S(e, t) || f.resolve()).catch(function () {}),
                                t)
                              );
                            });
                        });
                            ...
                            return new f(function (t, n) {
                              e.db.transaction(
                                function (r) {
                                  ...
                                  for (
                                    var i = [], a = 0, u = e.storeNames.length;
                                    a < u;
                                    a++
                                  )
                ...
                function Le(e) {
                  ...
                  if (e) for (var r in e) n[r] = e[r];
                  return (
                    (n.keyPrefix = ke(e, t._defaultConfig)),
                    Be()
                      ? ((t._dbInfo = n), (n.serializer = be), f.resolve())
                      : f.reject()
                  );
                }
                function Fe(e) {
                ...
                var Ke = {
                  ...
                  Xe = {},
                  Ze = {},
                  $e = { INDEXEDDB: K, WEBSQL: Pe, LOCALSTORAGE: Ke },
                  et = [
                    $e.INDEXEDDB._driver,
                    $e.WEBSQL._driver,
                ...
                var at = new ((function () {
                  function e(t) {
                    ...
                    (this._defaultConfig = it({}, rt)),
                      (this._config = it({}, this._defaultConfig, t)),
                  ...
                  return (
                    ...
                    (e.prototype.getDriver = function (e, t, n) {
                      var r = Xe[e]
                        ? f.resolve(Xe[e])
                        : f.reject(new Error('Driver not found.'));
                      return l(r, t, n), r;
                    }),
