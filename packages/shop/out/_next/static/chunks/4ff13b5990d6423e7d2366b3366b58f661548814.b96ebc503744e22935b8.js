  ...
  [16],
  {
    bdgK: function (t, e, n) {
      ...
      (function (t) {
        ...
        function l(t) {
          ...
          if (
            ('border-box' === i.boxSizing &&
              (Math.round(a + o) !== e && (a -= p(i, 'left', 'right') + o),
              Math.round(c + s) !== n && (c -= p(i, 'top', 'bottom') + s)),
            !(function (t) {
              return t === u(t).document.documentElement;
            })(t))
          ) {
            var h = Math.round(a + o) - e,
              l = Math.round(c + s) - n;
            1 !== Math.abs(h) && (a -= h), 1 !== Math.abs(l) && (c -= l);
          }
          return b(r.left, r.top, a, c);
        }
        var v =
        ...
        var O = 'undefined' !== typeof r.ResizeObserver ? r.ResizeObserver : E;
        e.a = O;
      }.call(this, n('yLpj')));
    },
    zoLa: function (t, e, n) {
      ...
      e.a = Object(c.withRouter)(function (t) {
        var e = t.href,
          n = t.label,
          i = t.intlId,
          r = t.router,
          ...
          c = t.onClick,
          d = t.iconClass,
          p = r.pathname === e || r.asPath === e;
        return u(
          'div',
          { onClick: c, className: s || '' },
          u(
            a.a,
            { href: e },
            u(
              ...
              u(
                ...
                { className: 'label' },
                i
                  ? u(h.a, { id: i || 'defaultNavLinkId', defaultMessage: n })
                  : n
              )
            )
          )
