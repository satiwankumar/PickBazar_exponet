  ...
  [22],
  {
          ...
          if ('title' !== t.type) {
            for (
              ...
              var u = i.next(),
                c = u.done,
                s = u.value;
              if (null == s ? void 0 : s.isEqualNode(n))
                return void a.delete(s);
              if (c) break;
            }
    ...
    IKlv: function (e, t, n) {
      ...
      var N = R.props,
        ...
        X = D || '';
      (n.p = ''.concat(X, '/_next/')),
        T.setConfig({ serverRuntimeConfig: {}, publicRuntimeConfig: F || {} });
      var G = (0, b.getURL)();
      (0, _.hasBasePath)(G) && (G = (0, _.delBasePath)(G)),
        (G = (0, _.delLocale)(G, U));
      var W = new x.default(L, X, M),
        Y = function (e) {
          var t = l(e, 2),
            n = t[0],
            r = t[1];
                    ...
                    J.isSsr &&
                      ...
                      J.replace(
                        J.pathname +
                          ...
                          String(
                            E.assign(
                              E.urlQueryToSearchParams(J.query),
              ...
              function (e) {
                for (;;)
                  switch ((e.prev = e.next)) {
                    ...
                    case 30:
                      return (
                        (t.router = J = (0, A.createRouter)(M, I, G, {
                          initialProps: N,
                          pageLoader: W,
                          App: Q,
                          Component: z,
          ...
          W.loadPage('/_error').then(function (r) {
            var a = r.page,
              ...
              u = {
                ...
                AppTree: i,
                router: J,
                ctx: { err: n, pathname: M, query: I, asPath: G, AppTree: i },
              };
            return Promise.resolve(
              e.props ? e.props : (0, b.loadGetInitialProps)(t, u)
            ).then(function (t) {
              return he(
                (0, h.default)({}, e, {
                  err: n,
      ...
      function de(e) {
        ...
        return m.default.createElement(
          ...
          m.default.createElement(
            ...
            { value: (0, A.makePublicRouterInstance)(J) },
            m.default.createElement(
      ...
      var pe = function (e) {
        return function (t) {
          var n = (0, h.default)({}, t, { Component: z, err: k, router: J });
          return m.default.createElement(
            de,
            null,
      ...
      function he(e) {
        var t = e.App,
          ...
          a = e.err,
          o = e.styleSheets;
        (n = n || K.Component), (r = r || K.props);
        var i = (0, h.default)({}, r, { Component: n, err: a, router: J });
        K = i;
        var u,
          c = !1,
            ...
            },
            {
              ...
              value: function (e, t, n, r) {
                ...
                return this.promisedSsgManifest.then(function (i, u) {
                  return (
                    i.has(o) &&
                    (u = a.getDataHref(e, t, !0, n, r)) &&
                    !document.querySelector(
                      'link[rel="'.concat(h, '"][href^="').concat(u, '"]')
                    ) &&
                    g(u, h, 'fetch').catch(function () {})
                  );
                });
              },
            },
            ...
            },
            {
              ...
              value: function (e, t) {
                ...
                ('/_app' === e
                  ...
                  : (r
                      ? Promise.resolve(
                          f(document.querySelectorAll('link[data-n-p]')).map(
                            function (e) {
